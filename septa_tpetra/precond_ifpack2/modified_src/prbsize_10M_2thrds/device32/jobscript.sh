...
#SBATCH -n 1920              # total number of mpi tasks requested
...
#Run the job
time mpirun -np 1920  /work/04051/vkotteda/stampede2/trilinos_3rd_openmp/run/precond_ifpack2/solve_ifpack.exe   
