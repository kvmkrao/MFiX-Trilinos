...
#SBATCH -o CG_mpi4_th2_output%j.txt     # output and error file name (%j expands to jobID)
...
time ibrun tacc_affinity /work/04051/vkotteda/stampede2/trilinos_3rd_openmp/run/precond_ifpack2/modified_src_matrixmarket/openmp_CG
