...
mpif90 -I. -I$src    -I$src/model/include -I$src/model -J$src/model -DMPI -O3 -ffree-form -ffree-line-length-none -fimplicit-none -cpp -c -o MFIXinterface.o ./WRAPPERS/MFIXinterface4_bak.f
