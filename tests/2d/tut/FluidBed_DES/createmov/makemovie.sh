...
for i in 00 02 04 06 08 10 12 14 16 18 20; do
 ...
 convert movie1/mfix2ddem_epg.00$i.png movie1/tri2d_dem_epg.00$i.png +append    movie1/auxilary1.00$i.png
...
(cd movie1; convert -delay $delay -quality 100 -normalize final.????.png mfixtri2ddem_epg.gif; rm auxilary* mfix2ddem_epg* tri2d_dem_epg* auxilary1* )
