...
!  <valid value="5" note="CG - Conjugate gradient"/>
      LEQ_METHOD(:) = 2
      key = "LEQ_METHOD(1)";  call xmlint(LEQ_METHOD(1), key)
      key = "LEQ_METHOD(2)";  call xmlint(LEQ_METHOD(2), key)
      key = "LEQ_METHOD(3)";  call xmlint(LEQ_METHOD(3), key)
      key = "LEQ_METHOD(4)";  call xmlint(LEQ_METHOD(4), key)
      key = "LEQ_METHOD(5)";  call xmlint(LEQ_METHOD(5), key)
      key = "LEQ_METHOD(6)";  call xmlint(LEQ_METHOD(6), key)
      key = "LEQ_METHOD(7)" ; call xmlint(LEQ_METHOD(7), key)
      key = "LEQ_METHOD(8)" ; call xmlint(LEQ_METHOD(8), key)
      key = "LEQ_METHOD(9)" ; call xmlint(LEQ_METHOD(9), key)
      key = "LEQ_METHOD(10)" ; call xmlint(LEQ_METHOD(10), key)
...
!  <dependent keyword="LEQ_METHOD" value="3"/>
      ...
      LEQ_TOL(:) = 1.0D-4
      key = "LEQ_TOL(1)";  call xmlflt(LEQ_TOL(1), key)
      key = "LEQ_TOL(2)";  call xmlflt(LEQ_TOL(2), key)
      key = "LEQ_TOL(3)";  call xmlflt(LEQ_TOL(3), key)
      key = "LEQ_TOL(4)";  call xmlflt(LEQ_TOL(4), key)
      key = "LEQ_TOL(5)";  call xmlflt(LEQ_TOL(5), key)
      key = "LEQ_TOL(6)";  call xmlflt(LEQ_TOL(6), key)
      key = "LEQ_TOL(7)" ; call xmlflt(LEQ_TOL(7), key)
      key = "LEQ_TOL(8)" ; call xmlflt(LEQ_TOL(8), key)
      key = "LEQ_TOL(9)" ; call xmlflt(LEQ_TOL(9), key)
      key = "LEQ_TOL(10)" ;call xmlflt(LEQ_TOL(10), key)
...
!  <arg index="1" id="Equation ID Number" min="1" max="DIM_EQS"/>
      ...
      key = "LEQ_IT(1)";  call xmlint(LEQ_IT(1), key)
      key = "LEQ_IT(2)";  call xmlint(LEQ_IT(2), key)
      key = "LEQ_IT(3)";  call xmlint(LEQ_IT(3), key)
      key = "LEQ_IT(4)";  call xmlint(LEQ_IT(4), key)
      key = "LEQ_IT(5)";  call xmlint(LEQ_IT(5), key)
      key = "LEQ_IT(6)";  call xmlint(LEQ_IT(6), key)
      key = "LEQ_IT(7)" ; call xmlint(LEQ_IT(7), key)
      key = "LEQ_IT(8)" ; call xmlint(LEQ_IT(8), key)
      key = "LEQ_IT(9)" ; call xmlint(LEQ_IT(9), key)
      key = "LEQ_IT(10)"; call xmlint(LEQ_IT(10), key)
...
!</keyword>
      ...
      key = "NODESI";  call xmlint(NODESI, key)
      key = "NODESJ";  call xmlint(NODESJ, key)
      key = "NODESK";  call xmlint(NODESK, key)
