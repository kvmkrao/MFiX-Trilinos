...
for i in 00 01 02 03 04 05 06 07 08 09 ; do
 echo $i
 convert  -pointsize 32 -annotate $posm "$textm" $path1/mfix3d_epg.00$i.png     movie2/mfix3ddem_epg.00$i.png
...
(cd movie2; convert -delay $delay -quality 100 -normalize finaln.???[1,3,5,7,9].png final.0000.png final.0000.png finaln.???[1,3,5,7,9].png mfixtri3dtfm_epg.gif; rm mfix3ddem_epg* tri3d_dem_epg* mfixtri3d_dem_epg* auxilary* )
(cd movie2; convert -delay $delay -quality 100 -normalize finaln.???[1,3,5,7,9].png final.0000.png final.0000.png finaln.???[1,3,5,7,9].png mfixtri3dtfm_epg.gif)
