...
for i in 00 01 02 03 04 05 06 07 08 09 ; do
 echo $i
 convert  -pointsize 32 -annotate $posm "$textm" $path1/mfix3d_cylepg.00$i.png  $dir/mfix3ddem_epg.00$i.png
 convert  -pointsize 32 -annotate $post "$textt" $path2/tri3dcyl_epg.00$i.png   $dir/auxilary$i.png
...
(cd $dir; convert -delay $delay -quality 100 -normalize $dir/final.0000.png $dir/final.0000.png  final.???[1,3,5,7,9].png mfixtri3dcyltfm_epg.gif; rm mfix3ddem_epg* tri3d_dem_epg*  mfixtri3d_dem_epg* auxilary* )
(cd $dir; convert -delay $delay -quality 100 -normalize $dir/final.0000.png $dir/final.0000.png final.???[1,3,5,7,9].png mfixtri3dcyltfm_epg.mp4)
