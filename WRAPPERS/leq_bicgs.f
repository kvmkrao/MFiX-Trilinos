...
! --------------------------------
	...
	write(*,*) " MFIX: rho_i ", time2 - time1, timec2 - timec1 
...
!	     write(*,*) "7 i /= 1 .no. use_doloop"
        ...
        write(*,*) " MFIX: p_i ", time3 - time2, timec3 - timec2
...
!$omp  parallel do default(shared) private(ijk) reduction(+:RtildexV)
        ...
        write(*,*) " MFIX: tilde v ", time4 - time3, timec4 - timec3
...
!!$omp end parallel do
	...
	write(*,*) " MFIX: s ", time6 - time4, timec6 - timec4 
...
!$omp  parallel do default(shared) private(ijk) reduction(+:TxS,TxT)
	...
	call cpu_time(timec7) 
        write(*,*) " MFIX: t ", time7 - time6, timec7 - timec6
...
!            if(prt) write(808,*) Var(:)
	...
	call cpu_time(timec9) 
        write(*,*) " MFIX: x_i, r_i", time9 - time7, timec9 - timec7
...
!            enddo
      ...
      deallocate(V)
        ...
        time10 = WALL_TIME()
	call cpu_time(timec10) 
      write(*,*) " MFIX: end bicgstab",   time10 - time9, timec10 - timec9
      write(*,*) " MFIX: total bicgstab", time10 - time0, timec10 - timec0
